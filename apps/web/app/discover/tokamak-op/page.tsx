'use client';
import BgMDark from '../../../public/background/bg-mobile-discover-op-dark.png';
import BgDDark from '../../../public/background/bg-desktop-discover-op-dark.png';
import BgTDark from '../../../public/background/bg-tablet-discover-op-dark.png';
import BgMLight from '../../../public/background/bg-mobile-discover-op-light.png';
import BgDLight from '../../../public/background/bg-desktop-discover-op-light.png';
import BgTLight from '../../../public/background/bg-tablet-discover-op-light.png';
import { getImageProps } from 'next/image';
import { useTheme } from 'next-themes';
import ComingSoon from '@/components/covers/coming-soon';

export default function TokamakOP() {
