...
export default function GlobalNav() {
  return (
    <div className="relative flex h-[78px] min-h-[78px] w-full items-center justify-between overflow-x-clip overflow-y-visible px-[20px] md:px-[30px]">
      <div className="absolute -top-[87px] left-[calc(50%-500px)] min-h-[174px] min-w-[1000px] rounded-[100%] bg-nav-blue blur-3xl"></div>
      <div className="flex">
